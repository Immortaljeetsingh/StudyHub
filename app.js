...
var h2r=function(h){var n=parseInt(h.slice(1),16);return (n>>16)+","+((n>>8)&255)+","+(n&255)};
var courses=[
...
{id:'mmpc02',name:'Human Resource Mgmt',desc:'Recruitment, Training, Performance Appraisal & Employee Relations',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',units:14,href:'study-mmpc02.html',quizHref:'quiz-mmpc02.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc03',name:'Business Environment',desc:'PESTEL Analysis, Economic Reforms, Globalization & CSR',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',units:14,href:'study-mmpc03.html',quizHref:'quiz-mmpc03.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
...
{id:'mmpc07',name:'Business Communication',desc:'Written & Oral Communication, Reports, Presentations & Cross-cultural',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',units:15,href:'study-mmpc07.html',quizHref:'quiz-mmpc07.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc08',name:'Information Systems',desc:'IT Fundamentals, SDLC, Databases, AI, ERP & Emerging Technologies',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',units:15,href:'study-mmpc08.html',quizHref:'quiz-mmpc08.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc09',name:'Machines & Materials',desc:'Operations, Work Study, Value Engineering, Inventory, SCM, Lean, JIT',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',units:14,href:'study-mmpc09.html',quizHref:'quiz-mmpc09.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc10',name:'Managerial Economics',desc:'Demand, Production Costs, Market Structures, Pricing, GDP, Inflation',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',units:12,href:'study-mmpc10.html',quizHref:'quiz-mmpc10.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc11',name:'Social Processes',desc:'Individual Behaviour, Motivation, Groups, Leadership, Culture, Change',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',units:15,href:'study-mmpc11.html',quizHref:'quiz-mmpc11.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc12',name:'Strategic Management',desc:'PESTEL, Porter, SWOT, BCG Matrix, Generic Strategies, Governance',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>',units:13,href:'study-mmpc12.html',quizHref:'quiz-mmpc12.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc13',name:'Business Law',desc:'Contract Act, Sale of Goods, Partnership, Companies Act, IPR, Consumer',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',units:14,href:'study-mmpc13.html',quizHref:'quiz-mmpc13.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc14',name:'Financial Management',desc:'TVM, WACC, Capital Budgeting, Capital Structure, Dividend, Forex',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',units:15,href:'study-mmpc14.html',quizHref:'quiz-mmpc14.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc15',name:'Research Methodology',desc:'Research Design, Data Collection, Sampling, Statistics, Correlation',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',units:14,href:'study-mmpc15.html',quizHref:'quiz-mmpc15.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc16',name:'International Business',desc:'IB Environment, Trade Theories, Culture, Entry Modes, Marketing Mix',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',units:13,href:'study-mmpc16.html',quizHref:'quiz-mmpc16.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc17',name:'Advanced Strategy',desc:'Corporate Strategy, M&A, Growth, International Strategy, Governance',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9H4.5a2.5 2.5 0 0 1 0-5H6"/><path d="M18 9h1.5a2.5 2.5 0 0 0 0-5H18"/><path d="M4 22h16"/><path d="M10 14.66V17c0 .55-.47.98-.97 1.21C7.85 18.75 7 20 7 22"/><path d="M14 14.66V17c0 .55.47.98.97 1.21C16.15 18.75 17 20 17 22"/><path d="M18 2H6v7a6 6 0 0 0 12 0V2Z"/></svg>',units:12,href:'study-mmpc17.html',quizHref:'quiz-mmpc17.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc18',name:'Entrepreneurship',desc:'Startup Ecosystem, Business Plans, Funding, Social Entrepreneurship',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"/><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 0 5 0"/><path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5"/></svg>',units:14,href:'study-mmpc18.html',quizHref:'quiz-mmpc18.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc19',name:'Total Quality Management',desc:'TQM, Deming, Six Sigma, ISO 9001, Quality Tools, Kaizen, DMAIC',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg>',units:15,href:'study-mmpc19.html',quizHref:'quiz-mmpc19.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmpc20',name:'Business Ethics & CSR',desc:'Ethics, Carroll Pyramid, Section 135, ESG, GRI, Sustainability',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',units:14,href:'study-mmpc20.html',quizHref:'quiz-mmpc20.html',color:'#c9302c',glow:'rgba(201,48,44,0.25)'},
{id:'mmph01',name:'Org Theory & Design',desc:'Organisation Theories, Structure Types, Mintzberg, Job Design, JCM',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="2" width="16" height="20" rx="2" ry="2"/><path d="M9 22v-4h6v4"/><path d="M8 6h.01"/><path d="M16 6h.01"/><path d="M12 6h.01"/><path d="M12 10h.01"/><path d="M12 14h.01"/><path d="M16 10h.01"/><path d="M16 14h.01"/><path d="M8 10h.01"/><path d="M8 14h.01"/></svg>',units:11,href:'study-mmph01.html',quizHref:'quiz-mmph01.html',color:'#d4a017',glow:'rgba(212,160,23,0.25)'},
{id:'mmph02',name:'Human Resource Development',desc:'HRD System, Training, Kirkpatrick, Mentoring, E-Learning, Competency',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>',units:12,href:'study-mmph02.html',quizHref:'quiz-mmph02.html',color:'#d4a017',glow:'rgba(212,160,23,0.25)'},
{id:'mmph04',name:'Industrial Relations',desc:'IR, Trade Unions, Collective Bargaining, Grievance, Discipline',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 17a4 4 0 0 0 8 0"/><path d="M7 17a4 4 0 0 1-4-4V7a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v6a4 4 0 0 1-4 4"/><path d="M12 3v6"/></svg>',units:15,href:'study-mmph04.html',quizHref:'quiz-mmph04.html',color:'#d4a017',glow:'rgba(212,160,23,0.25)'},
{id:'mmph07',name:'Compensation Mgmt',desc:'Compensation, Job Evaluation, EPF, ESI, Gratuity, ESOPs, Total Rewards',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',units:13,href:'study-mmph07.html',quizHref:'quiz-mmph07.html',color:'#d4a017',glow:'rgba(212,160,23,0.25)'},
{id:'mmpb06',name:'Banking Governance',desc:'Governance Principles, RBI, Basel, IRDAI, SEBI, ESG, Whistleblower',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 21h18"/><path d="M3 10h18"/><path d="M5 6l7-3 7 3"/><path d="M4 10v11"/><path d="M20 10v11"/><path d="M8 14v3"/><path d="M12 14v3"/><path d="M16 14v3"/></svg>',units:14,href:'study-mmpb06.html',quizHref:'quiz-mmpb06.html',color:'#9b3d8a',glow:'rgba(155,61,138,0.25)'},
{id:'mmpm01',name:'Consumer Behaviour',desc:'CB Model, Motivation, Perception, Decision Process',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2a8 8 0 0 0-8 8c0 6 8 12 8 12s8-6 8-12a8 8 0 0 0-8-8z"/><circle cx="12" cy="10" r="3"/></svg>',units:12,href:'study-mmpm01.html',quizHref:'quiz-mmpm01.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm02',name:'Sales Management',desc:'Selling Skills, AIDA, Sales Force, Quotas',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="7" width="20" height="14" rx="2" ry="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>',units:14,href:'study-mmpm02.html',quizHref:'quiz-mmpm02.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm03',name:'Product & Brand Mgmt',desc:'Product Levels, PLC, Brand Equity, Keller',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/></svg>',units:15,href:'study-mmpm03.html',quizHref:'quiz-mmpm03.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm04',name:'International Marketing',desc:'IM, Trade Theories, 4P, Entry Modes',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></svg>',units:13,href:'study-mmpm04.html',quizHref:'quiz-mmpm04.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm05',name:'Marketing of Services',desc:'IHIP, 7Ps, SERVQUAL, Yield Management',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 21c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.5 0 2.5 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M19.38 20A11.6 11.6 0 0 0 21 14l-9-4-9 4c0 2.9.94 5.34 2.81 7.76"/><path d="M19 13V7a2 2 0 0 0-2-2H7a2 2 0 0 0-2 2v6"/><path d="M12 10v4"/><path d="M12 2v3"/></svg>',units:14,href:'study-mmpm05.html',quizHref:'quiz-mmpm05.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm06',name:'Marketing Research',desc:'MR Process, Sampling, Statistics, Report',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/></svg>',units:15,href:'study-mmpm06.html',quizHref:'quiz-mmpm06.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm07',name:'Integrated Marketing Comm',desc:'IMC, Advertising, Digital Marketing',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>',units:14,href:'study-mmpm07.html',quizHref:'quiz-mmpm07.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpm09',name:'Retail Management',desc:'Formats, Location, E-commerce, Omnichannel',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>',units:16,href:'study-mmpm09.html',quizHref:'quiz-mmpm09.html',color:'#1d6b5a',glow:'rgba(29,107,90,0.25)'},
{id:'mmpo01',name:'Operations Research',desc:'Linear Programming, Transportation, Assignment, Sequencing, Queuing, Decision Theory & Simulation',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"/></svg>',units:16,href:'study-mmpo01.html',quizHref:'quiz-mmpo01.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo02',name:'Project Management',desc:'WBS, PERT/CPM, EVM, Contracts',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2"/><rect x="9" y="3" width="6" height="4" rx="1"/><path d="M9 12h6"/><path d="M9 16h6"/></svg>',units:14,href:'study-mmpo02.html',quizHref:'quiz-mmpo02.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo03',name:'Operations Management',desc:'Process, Capacity, Forecasting, Six Sigma',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',units:14,href:'study-mmpo03.html',quizHref:'quiz-mmpo03.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo04',name:'Management Info Systems',desc:'MIS, BI, Database, Cloud',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg>',units:14,href:'study-mmpo04.html',quizHref:'quiz-mmpo04.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo05',name:'Logistics & SCM',desc:'SCM, Transport, Warehousing, KPIs',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 3h15v13H1z"/><path d="M16 8h4l3 3v5h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>',units:14,href:'study-mmpo05.html',quizHref:'quiz-mmpo05.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo06',name:'Materials Management',desc:'ABC, VED, EOQ, Inventory',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m7.5 4.27 9 5.15"/><path d="M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z"/><path d="m3.3 7 8.7 5 8.7-5"/><path d="M12 22V12"/></svg>',units:13,href:'study-mmpo06.html',quizHref:'quiz-mmpo06.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpo08',name:'Management of R&D and Innovation',desc:'R&D Management, Innovation Types, NIS, Tech Transfer, Funding',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>',units:20,href:'study-mmpo08.html',quizHref:'quiz-mmpo08.html',color:'#3d4f8a',glow:'rgba(61,79,138,0.25)'},
{id:'mmpf01',name:'Working Capital Mgmt',desc:'WC Concepts, Current Assets, Financing, Cash Credit, MPBF',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>',units:15,href:'study-mmpf01.html',quizHref:'quiz-mmpf01.html',color:'#2d7a4f',glow:'rgba(45,122,79,0.25)'},
{id:'mmpf02',name:'Capital Investment',desc:'NPV, IRR, Payback, Capital Structure, Dividend Policy, M&M',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>',units:15,href:'study-mmpf02.html',quizHref:'quiz-mmpf02.html',color:'#2d7a4f',glow:'rgba(45,122,79,0.25)'},
{id:'mmpf03',name:'Management Control',desc:'MCS, Responsibility Centres, Transfer Pricing, Budget, Variance, BSC',icon:'<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 20a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8l-7 5V8l-7 5V4a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2Z"/></svg>',units:16,href:'study-mmpf03.html',quizHref:'quiz-mmpf03.html',color:'#2d7a4f',glow:'rgba(45,122,79,0.25)'}
];

var graphNodes=[
{id:'mmpc01',label:'MMPC-01',full:'Management Functions',units:14,x:0,y:0,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
{id:'mmpc02',label:'MMPC-02',full:'Human Resource Mgmt',units:14,x:-200,y:-100,color:'#d4a017',glow:'rgba(212,160,23,0.3)'},
{id:'mmpc03',label:'MMPC-03',full:'Business Environment',units:14,x:200,y:-100,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
...
{id:'mmpc07',label:'MMPC-07',full:'Business Communication',units:15,x:-380,y:0,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
{id:'mmpc08',label:'MMPC-08',full:'Information Systems',units:15,x:380,y:0,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpc09',label:'MMPC-09',full:'Machines & Materials',units:14,x:0,y:200,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
...
{id:'mmpc12',label:'MMPC-12',full:'Strategic Mgmt',units:13,x:-300,y:200,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpc13',label:'MMPC-13',full:'Business Law',units:14,x:300,y:200,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
{id:'mmpc14',label:'MMPC-14',full:'Financial Mgmt',units:15,x:-450,y:-100,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
...
{id:'mmpc17',label:'MMPC-17',full:'Advanced Strategy',units:12,x:450,y:100,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
{id:'mmpc18',label:'MMPC-18',full:'Entrepreneurship',units:14,x:-300,y:-220,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpc19',label:'MMPC-19',full:'Total Quality Mgmt',units:15,x:300,y:-220,color:'#2d7a4f',glow:'rgba(45,122,79,0.3)'},
{id:'mmpc20',label:'MMPC-20',full:'Business Ethics & CSR',units:14,x:0,y:-330,color:'#c9302c',glow:'rgba(201,48,44,0.3)'},
{id:'mmph01',label:'MMPH-01',full:'Org Theory & Design',units:11,x:-150,y:330,color:'#d4a017',glow:'rgba(212,160,23,0.3)'},
...
{id:'mmph07',label:'MMPH-07',full:'Compensation Mgmt',units:13,x:350,y:330,color:'#d4a017',glow:'rgba(212,160,23,0.3)'},
{id:'mmpb06',label:'MMPB-06',full:'Banking Governance',units:14,x:0,y:330,color:'#9b3d8a',glow:'rgba(155,61,138,0.3)'},
{id:'mmpm01',label:'MMPM-01',full:'Consumer Behaviour',units:12,x:-500,y:0,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm02',label:'MMPM-02',full:'Sales Management',units:14,x:500,y:0,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm03',label:'MMPM-03',full:'Product & Brand Mgmt',units:15,x:-380,y:-330,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm04',label:'MMPM-04',full:'International Marketing',units:13,x:380,y:-330,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm05',label:'MMPM-05',full:'Marketing of Services',units:14,x:-200,y:-330,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm06',label:'MMPM-06',full:'Marketing Research',units:15,x:200,y:-330,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm07',label:'MMPM-07',full:'Integrated Mktg Comm',units:14,x:0,y:-450,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
{id:'mmpm09',label:'MMPM-09',full:'Retail Management',units:16,x:-500,y:200,color:'#1d6b5a',glow:'rgba(29,107,90,0.3)'},
...
{id:'mmpo05',label:'MMPO-05',full:'Logistics & SCM',units:14,x:200,y:330,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpo06',label:'MMPO-06',full:'Materials Management',units:13,x:-500,y:-200,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpo08',label:'MMPO-08',full:'Management of R&D and Innovation',units:20,x:500,y:-200,color:'#3d4f8a',glow:'rgba(61,79,138,0.3)'},
{id:'mmpf01',label:'MMPF-01',full:'Working Capital Mgmt',units:15,x:-300,y:-450,color:'#2d7a4f',glow:'rgba(45,122,79,0.3)'},
...
aL(dark?"Dark mode on":"Light mode on")
},
...
card.setAttribute("role","link");
 ...
 card.style.setProperty("--card-color-rgb",h2r(c.color));
...
if((e.ctrlKey||e.metaKey)&&e.key==="k"){e.preventDefault();var inp=document.getElementById("globalSearch")||document.getElementById("courseSearch");if(inp){inp.focus();inp.select()}}
...
try{
 ...
 if(model)LS.setItem("studyhub-model",model.value);
...
(function(node,r){
g.addEventListener("mouseenter",function(ev){circ.setAttribute("opacity","1");circ.setAttribute("r",String(r+3));if(tooltip){tooltip.innerHTML="<strong>"+node.full+"</strong><br>"+node.units+" units";tooltip.style.left=(ev.clientX+14)+"px";tooltip.style.top=(ev.clientY+14)+"px";tooltip.classList.add("show")}});
